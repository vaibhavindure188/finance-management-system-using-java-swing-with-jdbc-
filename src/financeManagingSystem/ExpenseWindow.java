...
public class ExpenseWindow implements ActionListener {
	...
	public ExpenseWindow() {
		...
		String categoryList[] = { "Other", "Automobile", "Entertainment", "Family", "Food", "Health Care",
				"Home Office", "Household", "Insurance", "Loans", "Personal", "Tax", "Travel", "Utilities",
				"Vacation" };
		...
		jb_save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String fileContent = amt + "\t" + payee + "\t" + category + "\t" + payment + "\t" + payStatus + "\t"
							+ desc;
					...
					// Statement stm=con.createStatement();
					String query = "INSERT INTO Expense_Record values(" + amount + ",'" + payee + "','" + category
							+ "','" + payment + "','" + payStatus + "','" + desc + "')";
